...
double eva_with_future_possibility(vector<vector<int>> mapStat, int x, int y, int sheep_num = 16){
...
vector<int> InitPos(int mapStat[15][15])
{
...
/*
    ...
    Step : <x,y,m,dir> 
			...
			7 8 9
*/
vector<int> GetStep(int playerID,int mapStat[15][15], int sheepStat[15][15])
{
	...
	Node best_node = minmax(make_pair(mapStat_vec, sheepStat_vec), 4, playerID, INT_MIN, INT_MAX, playerID);
